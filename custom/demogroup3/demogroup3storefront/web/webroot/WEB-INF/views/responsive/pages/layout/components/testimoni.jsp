            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4" style="margin-bottom: 20px;">
                        <div class="card testimony-card">
                            <div class="card-header d-flex align-items-center">
                                <h2 class="name">Melaney Ricardo</h2>
                                <div class="ml-auto image">
                                    <picture>
                                        <source type="image/webp" data-srcset="https://inthebox.net/images/review-avatar.webp" srcset="https://inthebox.net/images/review-avatar.webp">
                                        <img src="https://inthebox.net/images/review-avatar.png" data-src="https://inthebox.net/images/review-avatar.png" class="pull-right lazyloaded" alt="Avatar">
                    ...
                    <div class="col-md-4" style="margin-bottom: 20px;">
                        <div class="card testimony-card">
                            <div class="card-header d-flex align-items-center">
                                <h2 class="name">novika stefani</h2>
                                <div class="ml-auto image">
                                    <picture>
                                        <source type="image/webp" data-srcset="https://inthebox.net/images/review-avatar.webp" srcset="https://inthebox.net/images/review-avatar.webp">
                                        <img src="https://inthebox.net/images/review-avatar.png" data-src="https://inthebox.net/images/review-avatar.png" class="pull-right lazyloaded" alt="Avatar">
                            ...
                            <div class="card-body">
                                ...
                                <div class="content">
                                    <div class="kt-margin-b-10">
                                        <strong>worth the quality, worth the price</strong>
                                    </div>
                    ...
                    <div class="col-md-4" style="margin-bottom: 20px;">
                        <div class="card testimony-card">
                            <div class="card-header d-flex align-items-center">
                                <h2 class="name">Rahmatullah Rahmatullah</h2>
                                <div class="ml-auto image">
                                    <picture>
                                        <source type="image/webp" data-srcset="https://inthebox.net/images/review-avatar.webp" srcset="https://inthebox.net/images/review-avatar.webp">
                                        <img src="https://inthebox.net/images/review-avatar.png" data-src="https://inthebox.net/images/review-avatar.png" class="pull-right lazyloaded" alt="Avatar">
                    ...
                    <div class="col-md-4" style="margin-bottom: 20px;">
                        <div class="card testimony-card">
                            <div class="card-header d-flex align-items-center">
                                <h2 class="name">Diana Veronica</h2>
                                <div class="ml-auto image">
                                    <picture>
                                        <source type="image/webp" data-srcset="https://inthebox.net/images/review-avatar.webp" srcset="https://inthebox.net/images/review-avatar.webp">
                                        <img src="https://inthebox.net/images/review-avatar.png" data-src="https://inthebox.net/images/review-avatar.png" class="pull-right lazyloaded" alt="Avatar">
                    ...
                    <div class="col-md-4" style="margin-bottom: 20px;">
                        <div class="card testimony-card">
                            <div class="card-header d-flex align-items-center">
                                <h2 class="name">rinaldo fitra</h2>
                                <div class="ml-auto image">
                                    <picture>
                                        <source type="image/webp" data-srcset="https://inthebox.net/images/review-avatar.webp" srcset="https://inthebox.net/images/review-avatar.webp">
                                        <img src="https://inthebox.net/images/review-avatar.png" data-src="https://inthebox.net/images/review-avatar.png" class="pull-right lazyloaded" alt="Avatar">
                            ...
                            <div class="card-body">
                                ...
                                <div class="content">
                                    <div class="kt-margin-b-10">
                                        <strong>Matras lembut, bantal empuk</strong>
                                    </div>
